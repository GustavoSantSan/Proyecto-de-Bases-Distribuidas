...
--@Descripción:    Definición de vistas con acceso a datos BLOB para el sitio rgpbdd_s2



create or replace view laptop as
  select l_f1.laptop_id,num_serie,cantidad_ram,caracteristicas_extras,
  ...
  where q1.laptop_id = l_f1.laptop_id;


create or replace view servicio_laptop as
  select num_servicio,laptop_id,importe,diagnostico,
    get_remote_serv_lap_f1_by_id(num_servicio,laptop_id) as factura,
    sucursal_id
