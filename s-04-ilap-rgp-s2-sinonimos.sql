...
--@Descripción:    Creación de sinónimos en el nodo RGP_S2 (Sur).
...
create or replace synonym tipo_tarjeta_video_r1
  for tipo_tarjeta_video_r_rgp_s2;
...
create or replace synonym tipo_almacenamiento_r1
  for tipo_almacenamiento_r_rgp_s2;
