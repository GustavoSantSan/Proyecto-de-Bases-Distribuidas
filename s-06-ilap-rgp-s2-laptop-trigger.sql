...
--@Fecha creación: 06/06/2026 2:52 a.m.
--@Descripción:    Trigger de laptop en el sitio con blob local.
...
begin
  case
    ...
    when inserting then
      ...
      insert into laptop_f1 ( laptop_id, foto ) values ( :new.laptop_id, :new.foto );
