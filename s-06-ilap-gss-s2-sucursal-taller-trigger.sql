...
--@Fecha creación: 07/06/2026 1:34 p.m.
--@Descripción:    Trigger para sucursal taller en el sitio GSS_S2.
      ...
      if v_count > 0 then
        ...
        if v_count > 0 then
          insert into sucursal_taller_f1(
            sucursal_id, dia_descanso, telefono_atencion
          )
          values(
            :new.sucursal_id,:new.dia_descanso,:new.telefono_atencion
          );
