...
--@Descripción:    Creación de sinónimos en el nodo RGP_S1 (OESTE).
...
create or replace synonym laptop_inventario_f1
  for laptop_inventario_f1_rgp_s1;
...
create or replace synonym tipo_tarjeta_video_r1
  for tipo_tarjeta_video_r_rgp_s1;
...
create or replace synonym tipo_almacenamiento_r1
  for tipo_almacenamiento_r_rgp_s1;
